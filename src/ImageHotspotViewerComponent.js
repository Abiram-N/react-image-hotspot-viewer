...
export function ImageHotspotViewerComponent({ image, hotspots, imageStyles, onAddHotspot, onUpdateHotspot, onDeleteHotspot }) {
                    ...
                    <div  >
                        <div>
                            <div className="hotspotimage-section-mobile">
                                <div id="hotspotimage-container" className="hotspotimage-container-mobile" onClick={onImageClick} style={{
                                    width: '100%',
                                }}>
                                    <img
                                        src={image}
                ...
                !mobileView && (
                    <div>
                        <div className="hotspotimage-section" style={{
                            ...
                            <div id="hotspotimage-container" className="hotspotimage-container" onClick={onImageClick} style={{
